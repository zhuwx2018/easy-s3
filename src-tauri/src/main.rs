...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::s3_commands::create_bucket,
            commands::s3_commands::delete_bucket,
            commands::s3_commands::create_folder,
            commands::s3_commands::get_bucket_object_count,
            commands::s3_commands::debug_http,
